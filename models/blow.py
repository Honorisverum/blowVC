...
class Model(nn.Module):
    ...
    def __init__(self, sqfactor, nblocks, nflows, ncha, ntargets, semb=128):
        ...
        self.embedding = nn.Embedding(ntargets, semb)
...
class CouplingNet(nn.Module):
    ...
    def forward(self, h, emb):
        ...
        h = torch.nn.functional.conv1d(h.view(1, -1, lchunk), w, bias=b, padding=self.kw // 2,
                                       groups=sbatch * nsq).view(sbatch, self.ncha, lchunk)
        # """
